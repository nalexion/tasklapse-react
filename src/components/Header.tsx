...
export default function Header({ onOpenTaskModal, onOpenArchive, onOpenSettings, onOpenCategories }: HeaderProps) {
  ...
  const syncBadgeClass = isGuest
    ...
    : 'text-[10px] bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 px-2 py-0.5 rounded-full font-normal';
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-white tracking-wide flex items-center gap-2">
              TaskLapse <span className="text-indigo-400 text-xs font-normal align-middle">v2.7.2</span>
