  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div className="glass-panel p-2 rounded-xl mb-6 flex items-center justify-between border-slate-700/50 overflow-hidden">
          ...
          <button 
            ...
            className="ml-4 px-4 py-2 bg-amber-500 hover:bg-amber-600 text-amber-950 font-bold rounded-lg text-sm flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(245,158,11,0.2)] whitespace-nowrap shrink-0 transition-all disabled:opacity-70 border border-amber-400"
          >
